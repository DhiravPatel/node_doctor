...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 150 diagnostics
...
It runs **150 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **150 diagnostics** across Security, Reliability, Bugs, Performance, and
