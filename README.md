...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 200 diagnostics
...
It runs **200 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **200 diagnostics** across Security, Reliability, Bugs, Performance, and
