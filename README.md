...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 180 diagnostics
...
It runs **180 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **180 diagnostics** across Security, Reliability, Bugs, Performance, and
