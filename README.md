...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 162 diagnostics
...
It runs **162 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **162 diagnostics** across Security, Reliability, Bugs, Performance, and
