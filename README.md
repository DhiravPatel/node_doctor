...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 134 diagnostics
...
It runs **134 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **134 diagnostics** across Security, Reliability, Bugs, Performance, and
