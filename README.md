...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 190 diagnostics
...
It runs **190 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **190 diagnostics** across Security, Reliability, Bugs, Performance, and
