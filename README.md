...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 160 diagnostics
...
It runs **160 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **160 diagnostics** across Security, Reliability, Bugs, Performance, and
