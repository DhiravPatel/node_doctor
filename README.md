...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 175 diagnostics
...
It runs **175 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **175 diagnostics** across Security, Reliability, Bugs, Performance, and
