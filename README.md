...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 188 diagnostics
...
It runs **188 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **188 diagnostics** across Security, Reliability, Bugs, Performance, and
