...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 164 diagnostics
...
It runs **164 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **164 diagnostics** across Security, Reliability, Bugs, Performance, and
