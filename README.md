...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 169 diagnostics
...
It runs **169 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **169 diagnostics** across Security, Reliability, Bugs, Performance, and
