...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 194 diagnostics
...
It runs **194 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **194 diagnostics** across Security, Reliability, Bugs, Performance, and
