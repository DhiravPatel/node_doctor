...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 161 diagnostics
...
It runs **161 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **161 diagnostics** across Security, Reliability, Bugs, Performance, and
