...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 182 diagnostics
...
It runs **182 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **182 diagnostics** across Security, Reliability, Bugs, Performance, and
