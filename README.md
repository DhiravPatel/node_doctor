...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 136 diagnostics
...
It runs **136 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **136 diagnostics** across Security, Reliability, Bugs, Performance, and
