...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 183 diagnostics
...
It runs **183 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **183 diagnostics** across Security, Reliability, Bugs, Performance, and
