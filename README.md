...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 165 diagnostics
...
It runs **165 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **165 diagnostics** across Security, Reliability, Bugs, Performance, and
