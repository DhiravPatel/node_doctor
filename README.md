...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 177 diagnostics
...
It runs **177 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **177 diagnostics** across Security, Reliability, Bugs, Performance, and
