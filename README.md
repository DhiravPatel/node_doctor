...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 154 diagnostics
...
It runs **154 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **154 diagnostics** across Security, Reliability, Bugs, Performance, and
