...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 196 diagnostics
...
It runs **196 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **196 diagnostics** across Security, Reliability, Bugs, Performance, and
