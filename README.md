...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 142 diagnostics
...
It runs **142 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **142 diagnostics** across Security, Reliability, Bugs, Performance, and
