...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 179 diagnostics
...
It runs **179 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **179 diagnostics** across Security, Reliability, Bugs, Performance, and
