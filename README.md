...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 166 diagnostics
...
It runs **166 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **166 diagnostics** across Security, Reliability, Bugs, Performance, and
