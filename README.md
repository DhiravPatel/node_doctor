...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 191 diagnostics
...
It runs **191 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **191 diagnostics** across Security, Reliability, Bugs, Performance, and
