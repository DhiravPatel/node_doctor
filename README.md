...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 181 diagnostics
...
It runs **181 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **181 diagnostics** across Security, Reliability, Bugs, Performance, and
