...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 163 diagnostics
...
It runs **163 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **163 diagnostics** across Security, Reliability, Bugs, Performance, and
