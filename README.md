...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 198 diagnostics
...
It runs **198 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **198 diagnostics** across Security, Reliability, Bugs, Performance, and
