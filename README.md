...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 171 diagnostics
...
It runs **171 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **171 diagnostics** across Security, Reliability, Bugs, Performance, and
