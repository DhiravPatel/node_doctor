...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 173 diagnostics
...
It runs **173 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **173 diagnostics** across Security, Reliability, Bugs, Performance, and
