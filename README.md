...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 187 diagnostics
...
It runs **187 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **187 diagnostics** across Security, Reliability, Bugs, Performance, and
