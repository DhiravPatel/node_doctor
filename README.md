...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 159 diagnostics
...
It runs **159 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **159 diagnostics** across Security, Reliability, Bugs, Performance, and
