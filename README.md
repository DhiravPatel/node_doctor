...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 176 diagnostics
...
It runs **176 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **176 diagnostics** across Security, Reliability, Bugs, Performance, and
