...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 178 diagnostics
...
It runs **178 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **178 diagnostics** across Security, Reliability, Bugs, Performance, and
