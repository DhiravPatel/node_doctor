...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 174 diagnostics
...
It runs **174 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **174 diagnostics** across Security, Reliability, Bugs, Performance, and
