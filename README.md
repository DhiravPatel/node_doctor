...
**[node-doctor.vercel.app](https://node-doctor.vercel.app/)** — browse all 192 diagnostics
...
It runs **192 diagnostics** — including a whole-tree scan for **committed secrets**
...
- **192 diagnostics** across Security, Reliability, Bugs, Performance, and
